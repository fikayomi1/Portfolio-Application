    ...
    return (
        <div className="flex flex-col md:flex-row py-20">
            ...
            <div className="flex items-center justify-center md:order-2 md:w-1/2 p-2">
                <img src={Pict} alt="Profile" className="rounded-full h-72 w-72" />
            </div>
            ...
            <div className="flex items-center justify-center md:order-1 md:w-1/2 p-4 lg:text-justify sm:text-center">
                <div className="max-w-xl py-10 px-20">
                    ...
                    <a href="#" className="font-semibold py-3 px-5 rounded-full bg-black text-white shadow-lg">View Projects <i class="fas fa-arrow-right text-white bg-black"></i></a>
                </div>
            </div>
